...
ALPM="/api/user/[a-zA-Z0-9-_]+/theme,/api/user/[a-zA-Z0-9-_]+/livestream,/api/livestream/[a-zA-Z0-9-_]+,/api/livestream/[a-zA-Z0-9-_]+/livecomment,/api/livestream/[a-zA-Z0-9-_]+/livecomment,/api/livestream/[a-zA-Z0-9-_]+/reaction,/api/livestream/[a-zA-Z0-9-_]+/reaction,/api/livestream/[a-zA-Z0-9-_]+/report,/api/livestream/[a-zA-Z0-9-_]+/ngwords,/api/livestream/[a-zA-Z0-9-_]+/livecomment/:livecomment_id/report,/api/livestream/[a-zA-Z0-9-_]+/moderate,/api/livestream/[a-zA-Z0-9-_]+/enter,/api/livestream/[a-zA-Z0-9-_]+/exit,/api/user/[a-zA-Z0-9-_]+,/api/user/[a-zA-Z0-9-_]+/statistics,/api/user/[a-zA-Z0-9-_]+/icon,/api/livestream/[a-zA-Z0-9-_]+/statistics"
