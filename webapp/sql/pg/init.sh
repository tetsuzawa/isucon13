...
psql -h ${ISUCON_DB_HOST} -U isucon -d isupipe -c "\COPY isupipe.reservation_slots FROM ./reservation_slots.csv DELIMITER ',' CSV";
psql -h ${ISUCON_DB_HOST} -U isucon -d isupipe -c "\COPY isupipe.reactions FROM ./reactions.csv DELIMITER ',' CSV";
